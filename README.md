...
It allows users to manage tasks visually across sections with authentication, drag & drop support, and real-time updates.
...
Create and manage boards, sections, and tasks

Move tasks between sections using drag & drop

Collaborate with multiple users

The repository contains both frontend and backend in a single mono-repo.
...
Vicky
Built as a full-stack MERN project to demonstrate real-world product development skills.

⭐ If you like this project

Give it a ⭐ on GitHub — it helps more than coffee ☕😄
...
i want readme md data into gitub add the team names vikas a r sufiyan and tejaswini vasantha

Got it 👍
Here’s your updated README.md with the team names added cleanly (GitHub-ready, no drama, no overdesign).
